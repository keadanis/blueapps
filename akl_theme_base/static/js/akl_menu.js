odoo.define('akl_theme_base.Menu', function (require) {
    ...
    var AklMenu = Menu.include({
        ...
        start: function () {
            ...
            var appsMenuProm =  this._appsMenu.insertBefore(this.$('.o_menu_systray'));
            ...
            var systrayMenuProm = this.systray_menu.attachTo(this.$('.o_menu_systray')).then(function () {
                ...
                // init auto more
                dom.initAutoMoreMenu(self.$('.akl_menu_apps'), {
                    maxWidth: function () {
                        return self.$el.width() - 80 - (
                            self.$('.company_logo').outerWidth(true) + self.systray_menu.$el.outerWidth(true));
                    },
                    sizeClass: 'SM',
                });
            });
