odoo.define('theme_ar_fashion.snippet_features_options', function (require) {
    'use strict';
    ...
    options.registry.snippet_features_options = options.Class.extend({
        onBuilt: function () {
            var self = this;
            return wUtils.prompt({
                window_title: "Add a Features Snippet",
                select: "Category",
                init: function () {
                    return rpc.query({
                ...
                self.$target.find('.features-snippet').attr("data-active-categ", category['val']);
            });
        },
    });
    ...
    options.registry.snippet_top_featured_options = options.Class.extend({
        ...
        slickAdd: function () {
            ...
            var html = `<div>
    <div class="item">
        <img src="/theme_ar_fashion/static/src/images/top-img.png" alt="preview"/>
        <div class="item-info">
            <h2>Heading Line</h2>
            <p>Simple texts</p>
