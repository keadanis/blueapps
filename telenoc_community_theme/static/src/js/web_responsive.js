...
odoo.define("telenoc_community_theme", function (require) {
    "use strict";
    ...
    AppsMenu.include({
        ...
        _searchMenus: function () {
            ...
            this.$search_results.html(
                core.qweb.render("telenoc_community_theme.MenuSearchResults", {
                    results: results,
                    widget: this,
                })
            );
    ...
    FormRenderer.include({
        ...
        _renderHeaderButtons: function () {
            ...
            const $dropdown = $(
                core.qweb.render("telenoc_community_theme.MenuStatusbarButtons")
            );
    ...
    PatchableAttachmentViewer.patch("telenoc_community_theme.AttachmentViewer", (T) => {
    ...
    ControlPanel.patch("telenoc_community_theme.ControlPanelMobile", (T) => {
    ...
    SearchPanel.patch("telenoc_community_theme.SearchPanelMobile", (T) => {
